...
## The sections I have completed and their exercises:
### CSS Foundations:
- [x] [Css Methods]
- [x] [Css Selectors]
- [x] [Css Groping Selectors]
- [x] [Css Chaining Selectors]
- [x] [Css Descendant Combinators]
- [x] [Css Specificity]
- [x] [Css Class and Id]
- [x] [CSS Block and inline]
- [x] [Css Margin and Padding]
- [x] [Css Box Model]
- [x] [Css Cascade]
- [x] [Css Flex]
- [x] [Css Flex-center]
- [x] [Css Flex-header]
- [x] [Css Flex-information]
- [x] [Css Flex-modal]
- [x] [Css Flex-layout]
